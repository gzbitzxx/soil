...
<div class="area-details-container"> 
    <div class="ads-addIndex">
        <div class="ads-addIndex-inner">
            ...
            <a href="#" title="南阳土地流转">贵阳土地租出</a> &gt;
            <a href="#" title="惠水土地租出">乌当</a> &gt;
            <a href="javascript:void(0)" title="惠水土地租出">贵阳200亩水田出租</a>
        </div>
    </div>
    <div class="ads-container clear">
        <div class="ads-detail">
            <p class="ads-detail-title">贵阳200亩水田出租</p>
            ...
            <div class="ads-detail-content clear" >
                        ...
                        <div id="carousel-example-multi" class="carousel slide linkedCarousel supply-control" data-interval="" data-ride="carousel" style="z-index:98;">
                            <div class="carousel-inner" role="listbox">
                                <div class="item ci-pic  active">
                                    ...
                                    <img src="../web/soil/images/img4.jpg" data-original="images/img4.jpg" alt="IMG">
                                ...
                                <div class="item ci-pic  ">
                                    <div class="del_sell_box">
                                        <img src="../web/soil/images/tu2.jpg" data-original="images/tu2.jpg" alt="IMG">
                                        <!-- <img src="../web/soil/images/img2.jpg" data-original="images/img2.jpg" alt="IMG"> -->
                                    </div>  
                                    <div class="ci-description">
                                        <span class="pull-left text_white margin-left-10"></span>
                                        <span class="pull-right text_white margin-right-10">2/3</span>
                                    </div>
                                </div>

                                <div class="item ci-pic  ">
                                    <div class="del_sell_box">
                                        <img src="../web/soil/images/tu3.jpg" data-original="images/tu3.jpg" alt="IMG">
                                        <!-- <img src="../web/soil/images/img3.jpg" data-original="images/img3.jpg/" alt="IMG"> -->
                                    </div>  
                                    <div class="ci-description">
                                        <span class="pull-left text_white margin-left-10"></span>
                                        <span class="pull-right text_white margin-right-10">3/3</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <tr>
                            ...
                            <td class="multi_nav_td _g1">
                                <div role="presentation" class="plot_img_list1 multi_nav_item active">
                                    <a href="/file">
                                        <img src="../web/soil/images/img4.jpg">
                                    </a>
                                </div>
                            </td>
                            <td class="multi_nav_td _g1">
                ...
                <div class="ads-detail-ctx " >
                    <div class="ads-detail-list1 clear">
                        <p>租金：<span class="ads-detail-cost">面议</span></p>
                    </div>
                    <div class="ads-detail-list2 ads-detail-list2-pb184">
                        <p class="ads-detail-list2-posi">
                            ...
                            <span>:</span>
                            <span class="ads-detail-margin" style="color:#37ac68;"><a href="#" target="_blank">出租</a></span>
                        </p>
                        <p class="ads-detail-list2-posi">
                        ...
                        <p class="ads-detail-list2-posi">
                            ...
                            <span>:</span>
                            <span class="ads-detail-margin">30年</span>
                        </p>
                        <p class="ads-detail-list2-posi">
                        ...
                        <p class="ads-detail-list2-posi">
                            ...
                            <span>: </span>
                            <a href="#" target="_blank">
                                <span style="color:#37ac68;">水田</span>
                            </a>
                        </p>
                        <p class="ads-detail-list2-posi">
                            <span class="ads-detail-list2-label">权证</span>
                            <span>:</span>
                            <span class="ads-detail-margin">-</span>
                        </p>
                        <p class="ads-detail-list2-posi">
                            <span class="ads-detail-list2-label">权证时间</span>
                            <span>:</span> 
                            <span class="ads-detail-margin">-</span>
                        </p>
                        <p class="ads-detail-list2-posi">
                            ...
                            <span>:</span>
                            <span class="ads-detail-margin" style="color:#37ac68;">水稻，莲藕</span>
                        </p>
                        <p class="ads-detail-list2-posi ads-detail-list2-posi-bh">
                            <span class="ads-detail-list2-label">编号</span>
                            <span>: </span>
                            <span style="color:#37ac68;margin-left:5px;display:inline-block;"> s55</span>
                        </p>
                    </div>
                    <div class="ads-detail-list3">
                        ...
                        <p>
                            ...
                            <span class="ads-detail-list3-tel">
                                ...
                                <span class="no_login_contact">15998752100</span>
                            </span>
                        </p>
            ...
            <div class="ads-detail-time">
                <p>2018-11-05更新</p>
                <p><font class="_view_num">46</font>次查看</p> 
            </div>
        </div>
        <div class="ads-con-left">
            <div style="height:50px;">
                <ul class="ads-tabs clear" style="position: static; top: 0px; left: 0px; z-index: 998; text-decoration: none;">
                    <li class="active">
                        土地流转详情
            ...
            <div class="ads-area-details window-scroll">
                ...
                <div class="details-label clear">
                    <div>设施配套</div>
                    <div><ul class="clear"><li>-</li></ul></div>
                </div>
                <div class="details-label clear">
                    <div>政策支持</div>
                    <div><ul class="clear"><li>-</li></ul></div>
            ...
            <div class="ads-area-details window-scroll">
                <p class="ads-details-title">区域介绍<span>—— 贵州 贵阳 乌当</span></p>
                <div class="ads-details-maps">
                    <img src="../web/soil/images/guiyang1.png">
                </div>
                <div class="ads-detail-areaIntro">
                    <p class="ads-areaIntro-title">贵州 贵阳 乌当</p>
                        <div class="ads-areaIntro-desc" style="height: 120px;">
                            <p>乌当区是中华人民共和国贵州省贵阳市东北部的一个市辖区。东经106°30'-107°03'，北纬26°55'-26°33'。</p>
                            <p>目前下辖：新天街道和高新路街道;东风镇、水田镇、羊昌镇、金华镇和朱昌镇;偏坡布依族乡、下坝乡、百宜乡、新堡布依族乡、野鸭乡和新场乡。</p>
