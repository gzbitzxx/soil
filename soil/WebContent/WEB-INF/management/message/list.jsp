			...
			<div class="modal-content">
				...
				<form id="data">
					<div class="modal-body">
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="form-group" lang="createUserId">
									<label for="username">发送者人：</label> <input type="text"
										class="form-control" name="createUserId" id="createUserId"
										placeholder="发送者" data-val="true"
										data-val-required="请填写 &#39;发送者&#39;。"> <span
										class="field-validation-error" data-valmsg-for="createUserId"
							...
							<div class="col-lg-12">
								<div class="form-group" lang="realName">
									<label for="realName">接收者：</label> <input type="text"
										class="form-control" name="replayUserId" id="replayUserId" placeholder="接收者"
										data-val="true" data-val-required="请填写 &#39;接收者&#39;。">
									<span class="field-validation-error" data-valmsg-for="replayUserId"
										data-valmsg-replace="true"></span>
								</div>
							</div>
							...
							<div class="col-lg-12">
								<div class="form-group" lang="content">
									<label for="phone">内容：</label> <input type="text"
										class="form-control" name="content" id="content"
										placeholder="消息内容" data-val="true"
										data-val-required="请填写 &#39;发布消息&#39;。"> <span
