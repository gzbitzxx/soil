...
<script type="text/javascript">
	$(function() {
		init("");
		SelectInfo("findIDAndNumberSoilTypeId", "#parentid");
	})
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">添加土地类型信息</h4>
				</div>
				<form id="data">
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="form-group" lang="parentid">
									<label for="parentid">父类型：</label> </label> <select name="parentid"
							...
							<div class="col-lg-12">
								<div class="form-group" lang="name">
									<label for="name">类型名称：</label> <input type="text"
